# E-Commerce Back-End
This application allows the user to add, update, read, and delete products, tags, or categories in a database designed to manage an e-commerce site. 
  ...
  - Run
     - `npm i`   
     - `SOURCE schema.sql` and `node seeds/` to build database 
